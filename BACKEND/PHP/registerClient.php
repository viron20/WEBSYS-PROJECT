 ...
 <header class="header">
  <div class="container">
    ...
    <div class="container registration-container">
        <h1 class="text-center mb-4">Sign up as a Client</h1>
        <p class="text-muted"> Find Top Clients</p>
...
<form method="POST" action="">
    ...
    <div class="form-check mb-3">
        ...
        <label class="form-check-label" for="marketingEmails">
            Send me helpful emails to find dedicated freelancer that fit my needs.
        </label>
    </div>
